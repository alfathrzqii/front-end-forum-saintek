...
export default function ThreadDetail() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Link to="/" className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 mb-6 transition-colors duration-200">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm overflow-hidden transition-colors duration-200">
        {deleteError && (
          <div className="bg-red-50 dark:bg-red-900/30 border-b border-red-100 dark:border-red-800/50 p-3 text-sm text-red-600 dark:text-red-400 flex justify-between items-center">
        ...
        <div className="p-6">
          ...
          {/* Thread Content */}
          <h1 className="text-3xl font-extrabold text-gray-900 dark:text-gray-100 mb-6">{title}</h1>

          <div className="text-lg leading-relaxed text-gray-800 dark:text-gray-300 whitespace-pre-wrap mb-8">
            {content}
          </div>

          {/* Action Bar */}
          <div className="flex items-center space-x-4 text-gray-500 dark:text-gray-400 text-sm border-t border-gray-100 dark:border-gray-700 pt-4">
            <VoteButton
              threadId={threadId}
            ...
            <button
              ...
              className="flex items-center space-x-2 hover:bg-gray-100 dark:hover:bg-gray-700 p-1 px-2 rounded transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {canDelete && (
              <button
                ...
                disabled={isDeleting}
                className={`flex items-center space-x-1 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 p-1 px-2 rounded transition-colors ${isDeleting ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
